    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-[var(--background-secondary)] border border-[var(--border-primary)] rounded-2xl shadow-2xl p-8 max-w-md w-full relative">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-2">Go Premium!</h2>
          <p className="text-[var(--text-secondary)] mb-6">Unlock unlimited photo edits and unleash your creativity without limits.</p>
          ...
          <p className="text-xs text-[var(--text-secondary)]/80 mt-4">This is a simulation. No real payment will be processed.</p>
        </div>
      </div>
    </div>
  );
