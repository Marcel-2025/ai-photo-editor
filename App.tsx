...
const PROMPT_SUGGESTIONS = [
  ...
  'as a retro 8-bit pixel art character',
  'in the style of a modern Pixar character',
  'with a pop-art, Andy Warhol effect',
  'as a character in a 90s cartoon',
  'with a stained glass window effect',
  'in a gritty comic book art style',
  'as a charcoal sketch on paper',

  // --- Lighting & Mood ---
  'with dramatic, cinematic lighting',
  'with soft, golden hour lighting',
  'with a moody, film noir atmosphere',
  'illuminated by neon signs in a dark alley',
  'with a cheerful, sunny atmosphere',
  'with a mysterious, foggy mood',
  'in a dark, fantasy forest with glowing mushrooms',
  'with volumetric, god-ray lighting',

  // --- Scene & Environment ---
  'change the background to a cyberpunk city at night',
  'change the background to a tranquil Japanese garden',
  'place the subject on the surface of Mars',
  'change the background to an enchanted fantasy forest',
  'place the subject in a scene from the 1920s',
  'change the background to a post-apocalyptic wasteland',
  'put them in an underwater scene with coral reefs',
  'extend the existing image with more details',

  // --- Character Modifications ---
  'change the clothes to a futuristic sci-fi suit',
  'change the clothes to elegant medieval royal attire',
  'add intricate tattoos on the arm',
  'give the person majestic, feathery wings',
  'make the person wear stylish sunglasses',
  'add a superhero cape that is flowing in the wind',
  'give them pointed elven ears',
  'change their hair to be long and silver',

  // --- Surreal & Abstract ---
  'create a double exposure effect with a forest scene',
  'apply a surreal, Salvador Dali-inspired effect',
  'create a glitch art effect with digital distortion',
  'turn the image into a kaleidoscope pattern',
  'make it look like a collage of different photos',

  // --- Time & Weather ---
  'make it nighttime with a starry sky',
  'add a gentle snowfall to the scene',
  'make it look like a scene during a dramatic thunderstorm',
  'add a rainbow in the background',
  'make it a foggy, autumn morning',
  'show the scene during a vibrant sunset',
];
